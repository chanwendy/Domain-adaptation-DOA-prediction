...
def dataload(len_sequence, case_nums=1, traindata="train", time_step=10, ):
    ...
    for i in tqdm(range(case_nums)):
        if traindata == "train":
            ...
            df = read_csv(f'/home/user02/TUTMING/ming/adarnn/dataset/data/waiting_train/{case_id[i]}.csv')
        elif traindata == 'test':
            # df = read_csv(f'/home/user02/TUTMING/ming/adarnn/dataset/data/new_test_clean/{case_id[i]}.csv')
            df = read_csv(f'/home/user02/TUTMING/ming/adarnn/dataset/data/waiting_test/{case_id[i]}.csv')
        else:
            df = read_csv(f'/home/user02/TUTMING/ming/adarnn/dataset/data/waiting_valid/{case_id[i]}.csv')
...
# loader = TDC_train_data_loader(180, 1, 64)
